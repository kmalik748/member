<?php
  require 'app/app.php';
    if(isset($_POST["add_new_committee"])){
        ...
        $sql = "INSERT INTO committee (name) VALUES ('$committee_name')";
        if(phpRunSingleQuery($sql)){
            js_alert("Committee Added!");
    ...
    if(isset($_POST["update_committee"])){
        ...
        $sql = "UPDATE committee set name='$committee_name', description='$committee_desc' WHERE id=$commettiee_id";
        if(phpRunSingleQuery($sql)){
            js_alert("Organization Updated!");
            js_redirect("admin_committees.php");
        }else{
            js_alert("ERROR");
        }
                            ...
                            <div class="col-md-10">
                                <div class="card">
                                    <div class="card-header">
                                        <i class="fas fa-edit mr-2"></i>Create New Contact
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control" id="inputEmail3" name="committee_name" required>
                                                </div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <form action="" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="EmailContent" class="col-sm-3 col-form-label">Description</label>
                                                        <div class="col-sm-12">
                                                            <textarea rows="5" class="form-control" id="EmailContent" name="committee_desc" required=""><?php echo $row["description"]; ?></textarea>
                                                        </div>
                                                    </div>
