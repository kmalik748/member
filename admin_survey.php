<?php
  require 'app/app.php';
    if(isset($_POST["add_new_course"])){
        ...
        $date1 = $_POST["date1"];
        $date2 = $_POST["date2"];
        $sql = "INSERT INTO survey (name, cat, date1, date2) VALUES ('$name', '$cat', '$date1', '$date2')";
        if(phpRunSingleQuery($sql)){
            js_alert("Survey Added!");
            js_redirect("admin_survey.php");
        }else{
            js_alert("ERROR");
        }
    }
            ...
            <div class="col-md-9">
                <div class="tab-content" id="myTabContent">
                            ...
                            <div class="col-md-10">
                                <div class="card">
                                    <div class="card-header">
                                        <i class="fas fa-edit mr-2"></i>Create a new Survey
                                    </div>
                                    <div class="card-body">
                    ...
                    <div class="tab-pane fade" id="organization" role="tabpanel" aria-labelledby="organization-tab">
                        <a class="btn btn-info mb-2 float-right mr-3" href="admin_survey.php">
                            Add new Survey
                        </a>
                        ...
                        <table id="example" class="table table-striped table-bordered bg-white shadow" style="width:100%">
                            ...
                            if(isset($_POST["update"])){
                                ...
                                $sql = "UPDATE survey SET name='$name',  date1='$startdate', date2='$enddate'
                                         WHERE id = $id";
                                if(mysqli_query($con, $sql)){
                                    js_alert("Survey Updated!");
                                    js_redirect("./admin_survey.php");
                                }else{
