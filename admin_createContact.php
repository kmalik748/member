...
<body>
  ...
  <div class="container">
    ...
    <div class="widget-content" style="border: none; background: transparent;">
                  ...
                  <div class="modal-body">
                      <form method="POST" action="">
                          <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="exampleInputEmail1" name="new_org" placeholder="New Organization Name">
                          </div>
                          <hr>
                          <div align="right">
                              <button type="submit" class="btn btn-info" name="add_new_org">
      ...
      <?php
        if(isset($_POST["add_new_org"])){
            $name = $_POST["new_org"];

            $sql = "INSERT INTO organizations (name) VALUES ('$name')";
            $output = phpRunSingleQuery();
            if($output == true){
                js_alert("Organization Added Successfully!");
            ...
            $sql = "INSERT INTO users (first_name, middle_name, last_name, email, password, organizationID,
                   jobTitle, salutation, dob, phone, gender, language, is_admin, address)
                    VALUES ('$first_name', '$middle_name', '$last_name', '$email', '$pass', '$organization',
                            '$jobTitle', '$salutation', '$dob', '$contact_num', '$gender', '$last_name', 0, '$address')";
            $output = phpRunSingleQuery($sql);

            if($output == true){
                js_alert("Contact Added Successfully!");
                js_redirect("admin_createContact.php");
            }else{
                js_alert("Error! Check console for details! ");
                js_redirect("admin_createContact.php");
